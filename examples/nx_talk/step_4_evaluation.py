...
python3 step_4_evaluation.py --model_name unsloth/Qwen2-0.5B-Instruct-bnb-4bit --output_file evaluation-epoch-0-talk-Qwen2-0.5B-Instruct.jsonl
python3 step_4_evaluation.py --model_name Qwen2-0.5B-Instruct-talk-model/checkpoint-100 --output_file evaluation-epoch-5-talk-Qwen2-0.5B-Instruct.jsonl
...
python3 step_4_evaluation.py --model_name unsloth/Meta-Llama-3.1-8B-Instruct-bnb-4bit --output_file evaluation-epoch-0-talk-Meta-Llama-3.1-8B-Instruct.jsonl
python3 step_4_evaluation.py --model_name Meta-Llama-3.1-8B-Instruct-talk-model/checkpoint-100 --output_file evaluation-epoch-5-talk-Meta-Llama-3.1-8B-Instruct.jsonl
python3 step_4_evaluation.py --model_name Meta-Llama-3.1-8B-Instruct-talk-model/checkpoint-200 --output_file evaluation-epoch-10-talk-Meta-Llama-3.1-8B-Instruct.jsonl
