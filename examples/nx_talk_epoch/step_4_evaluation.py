...
python3 step_4_evaluation.py --model_name Qwen2-1.5B-Instruct-talk/checkpoint-100 --output_file data_dir/evaluation-epoch-5-talk-Qwen2-1.5B-Instruct.jsonl
python3 step_4_evaluation.py --model_name Qwen2-1.5B-Instruct-talk/checkpoint-200 --output_file data_dir/evaluation-epoch-10-talk-Qwen2-1.5B-Instruct.jsonl
...
python3 step_4_evaluation.py --model_name Qwen2-0.5B-Instruct-talk/checkpoint-100 --output_file data_dir/evaluation-epoch-5-talk-Qwen2-0.5B-Instruct.jsonl
python3 step_4_evaluation.py --model_name Qwen2-0.5B-Instruct-talk/checkpoint-200 --output_file data_dir/evaluation-epoch-10-talk-Qwen2-0.5B-Instruct.jsonl
...
python3 step_4_evaluation.py --model_name Meta-Llama-3.1-8B-Instruct-talk/checkpoint-100 --output_file data_dir/evaluation-epoch-5-talk-Meta-Llama-3.1-8B-Instruct.jsonl
python3 step_4_evaluation.py --model_name Meta-Llama-3.1-8B-Instruct-talk/checkpoint-200 --output_file data_dir/evaluation-epoch-10-talk-Meta-Llama-3.1-8B-Instruct.jsonl
